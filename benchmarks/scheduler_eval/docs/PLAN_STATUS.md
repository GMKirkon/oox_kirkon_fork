...
| Secondary applications | All 12 PBBS application families, eight original serial implementations; seven original PBBS text/mesh archives and original-author w3c2 acquisition | Eight originals materialized and checksum-verified locally; hardware runs excluded |
